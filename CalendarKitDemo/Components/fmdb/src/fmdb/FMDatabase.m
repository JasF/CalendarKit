...
- (BOOL)executeStatements:(NSString *)sql withResultBlock:(int(NS_NOESCAPE ^)(NSDictionary *resultsDictionary))block {
...
- (NSError*)inSavePoint:(void (NS_NOESCAPE ^)(BOOL *rollback))block {
#if SQLITE_VERSION_NUMBER >= 3007000
