...
- (void)inDatabase:(void (NS_NOESCAPE ^)(FMDatabase *db))block {
#ifndef NDEBUG
...
- (void)inTransaction:(void (NS_NOESCAPE ^)(FMDatabase *db, BOOL *rollback))block {
    [self beginTransaction:FMDBTransactionExclusive withBlock:block];
}

- (void)inDeferredTransaction:(void (NS_NOESCAPE ^)(FMDatabase *db, BOOL *rollback))block {
    [self beginTransaction:FMDBTransactionDeferred withBlock:block];
}

- (void)inExclusiveTransaction:(void (NS_NOESCAPE ^)(FMDatabase *db, BOOL *rollback))block {
    [self beginTransaction:FMDBTransactionExclusive withBlock:block];
}

- (void)inImmediateTransaction:(void (NS_NOESCAPE ^)(FMDatabase * _Nonnull, BOOL * _Nonnull))block {
    [self beginTransaction:FMDBTransactionImmediate withBlock:block];
}

- (NSError*)inSavePoint:(void (NS_NOESCAPE ^)(FMDatabase *db, BOOL *rollback))block {
